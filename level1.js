...
//initialising game charecters
const man = document.getElementById("man");
const spider = document.getElementById("spider");
const rat = document.getElementById("rat");

//initialising game coins
...
//initialising game score
var score = document.getElementById("score");

//initialising game sound effects
...
//setting event listeners to start the game
...
//setting button event listeners to start the game
...
function startplay(){
    ...
    setInterval(()=>{
        ...
        // getting the border of the elements to check the colission
        ...
        //checking the colission of the MAN and other elements
